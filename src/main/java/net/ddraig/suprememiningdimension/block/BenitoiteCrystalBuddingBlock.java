...
public class BenitoiteCrystalBuddingBlock extends Block {
	...
	public BenitoiteCrystalBuddingBlock() {
		super(BlockBehaviour.Properties.of(Material.STONE).sound(SoundType.AMETHYST).strength(1f, 10f).lightLevel(s -> 4).requiresCorrectToolForDrops().noOcclusion().isRedstoneConductor((bs, br, bp) -> false));
