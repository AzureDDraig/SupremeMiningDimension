...
import net.ddraig.suprememiningdimension.procedures.CobaltOreFortuneProcedure;
...
public class CobaltOreBlock extends Block {
	...
	public boolean onDestroyedByPlayer(BlockState blockstate, Level world, BlockPos pos, Player entity, boolean willHarvest, FluidState fluid) {
		...
		CobaltOreFortuneProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ(), blockstate, entity);
		return retval;
	}
}
