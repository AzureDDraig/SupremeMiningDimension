...
public class DuckEntity extends TamableAnimal {
	public DuckEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SupremeMiningDimensionModEntities.DUCK.get(), world);
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		DuckEntity retval = SupremeMiningDimensionModEntities.DUCK.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(SupremeMiningDimensionModEntities.DUCK.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
			return DuckboolProcedure.execute();
		});
	}
