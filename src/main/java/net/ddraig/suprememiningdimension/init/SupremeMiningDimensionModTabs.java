...
public class SupremeMiningDimensionModTabs {
	...
	public static final RegistryObject<CreativeModeTab> SUPREME_MINING_DIMENSIONS = REGISTRY.register("supreme_mining_dimensions", () -> CreativeModeTab.builder()
			.title(Component.translatable("item_group.supreme_mining_dimension.supreme_mining_dimensions")).icon(() -> new ItemStack(SupremeMiningDimensionModItems.STRANGE_FORESTS.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLUE_PALE.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLUE_GLOWING.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLUE_PALE_GLOWING.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_CYAN.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_CYAN_PALE.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_CYAN_GLOWING.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_CYAN_PALE_GLOWING.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_GREEN.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_GREEN_PALE.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_GREEN_GLOWING.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_GREEN_PALE_GLOWING.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_PURPLE.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_PURPLE_PALE.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_PURPLE_GLOWING.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_PURPLE_PALE_GLOWING.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_YELLOW.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_YELLOW_PALE.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_YELLOW_GLOWING.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_YELLOW_PALE_GLOWING.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_ORANGE.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_ORANGE_PALE.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_ORANGE_GLOWING.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_ORANGE_PALE_GLOWING.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_RED.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_RED_PALE.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_RED_GLOWING.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_RED_PALE_GLOWING.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_WHITE.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_WHITE_GLOWING.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLACK.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLACK_PALE.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLACK_GLOWING.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLACK_PALE_GLOWING.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLACK_BLUE.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLACK_BLUE_PALE.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLACK_BLUE_GLOWING.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLACK_BLUE_PALE_GLOWING.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLACK_CYAN.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLACK_CYAN_PALE.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLACK_CYAN_GLOWING.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLACK_CYAN_PALE_GLOWING.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLACK_DARK_GREEN.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLACK_DARKGREEN_PALE.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLACK_DARK_GREEN_GLOWING.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLACK_DARKGREEN_PALE_GLOWING.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLACK_GREEN.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLACK_GREEN_PALE.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLACK_GREEN_GLOWING.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLACK_GREEN_PALE_GLOWING.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLACK_PURPLE.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLACK_PURPLE_PALE.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLACK_PURPLE_GLOWING.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLACK_PURPLE_PALE_GLOWING.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLACK_YELLOW.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLACK_YELLOW_PALE.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLACK_YELLOW_GLOWING.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLACK_YELLOW_PALE_GLOWING.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLACK_ORANGE.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLACK_ORANGE_PALE.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLACK_ORANGE_GLOWING.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLACK_ORANGE_PALE_GLOWING.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLACK_RED.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLACK_RED_PALE.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLACK_RED_GLOWING.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.MUSHROOM_STALK_BLACK_RED_PALE_GLOWING.get().asItem());
				...
				tabData.accept(SupremeMiningDimensionModBlocks.GABBRO_BRICKS_CRACKED.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.GABBRO_TILES.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.GABBRO_TILES_CRACKED.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.GABBRO_LARGE_TILES.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.GABBRO_LARGE_TILES_CRACKED.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.GABBRO_BRICKS_CHISELED.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.GABBRO_BRICKS_CHISELED_CRACKED.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.GABBRO_WALL.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.GABBRO_BRICKS_WALL.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.GABBRO_BRICKS_CRACKED_WALL.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.GABBRO_TILES_WALL.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.GABBRO_TILES_CRACKED_WALL.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.GABBRO_LARGE_TILES_WALL.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.GABBRO_LARGE_TILES_CRACKED_WALL.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.GABBRO_BRICKS_CHISELED_WALL.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.GABBRO_BRICKS_CHISELED_CRACKED_WALL.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.COBBLED_GABBRO_WALL.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.COBBLED_GABBRO_SLAB.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.GABBRO_SLAB.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.GABBRO_BRICKS_SLAB.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.GABBRO_BRICKS_CRACKED_SLAB.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.GABBRO_TILES_SLAB.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.GABBRO_TILES_CRACKED_SLAB.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.GABBRO_LARGE_TILES_SLAB.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.GABBRO_LARGE_TILES_CRACKED_SLAB.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.GABBRO_BRICKS_CHISELED_SLAB.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.GABBRO_BRICKS_CHISELED_CRACKED_SLAB.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.COBBLED_GABBRO_STAIRS.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.GABBRO_STAIRS.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.GABBRO_BRICKS_STAIRS.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.GABBRO_BRICKS_CRACKED_STAIRS.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.GABBRO_TILES_STAIRS.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.GABBRO_TILES_CRACKED_STAIRS.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.GABBRO_LARGE_TILES_STAIRS.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.GABBRO_LARGE_TILES_CRACKED_STAIRS.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.GABBRO_BRICKS_CHISELED_STAIRS.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.GABBRO_BRICKS_CHISELED_CRACKED_STAIRS.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.IGNIMBRITE.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.COBBLED_IGNIMBRITE.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.IGNIMBRITE_BRICKS.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.IGNIMBRITE_BRICKS_CRACKED.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.IGNIMBRITE_BRICKS_SLAB.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.IGNIMBRITE_BRICKS_CRACKED_SLAB.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.IGNIMBRITE_BRICKS_CHISELED.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.IGNIMBRITE_BRICKS_CHISELED_CRACKED.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.IGNIMBRITE_BRICKS_CHISELED_SLAB.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.IGNIMBRITE_BRICKS_CHISELED_CRACKED_SLAB.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.IGNIMBRITE_BRICKS_CHISELED_STAIRS.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.IGNIMBRITE_BRICKS_CHISELED_CRACKED_STAIRS.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.IGNIMBRITE_BRICKS_CHISELED_WALL.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.IGNIMBRITE_BRICKS_CHISELED_CRACKED_WALL.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.IGNIMBRITE_BRICKS_STAIRS.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.IGNIMBRITE_BRICKS_CRACKED_STAIRS.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.IGNIMBRITE_BRICKS_WALL.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.IGNIMBRITE_BRICKS_CRACKED_WALL.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.IGNIMBRITE_TILES.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.IGNIMBRITE_TILES_CRACKED.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.IGNIMBRITE_TILES_SLAB.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.IGNIMBRITE_TILES_STAIRS.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.IGNIMBRITE_TILES_WALL.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.IGNIMBRITE_TILES_CRACKED_SLAB.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.IGNIMBRITE_TILES_CRACKED_STAIRS.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.IGNIMBRITE_TILES_CRACKED_WALL.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.IGNIMBRITE_LARGE_TILES.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.IGNIMBRITE_LARGE_TILES_CRACKED.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.IGNIMBRITE_LARGE_TILES_SLAB.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.IGNIMBRITE_LARGE_TILES_STAIRS.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.IGNIMBRITE_LARGE_TILES_WALL.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.IGNIMBRITE_LARGE_TILES_CRACKED_SLAB.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.IGNIMBRITE_LARGE_TILES_CRACKED_STAIRS.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.IGNIMBRITE_LARGE_TILES_CRACKED_WALL.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.COBBLED_IGNIMBRITE_SLAB.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.COBBLED_IGNIMBRITE_STAIRS.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.COBBLED_IGNIMBRITE_WALL.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.IGNIMBRITE_SLAB.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.IGNIMBRITE_STAIRS.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.IGNIMBRITE_WALL.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.SYENITE.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.COBBLED_SYENITE.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.COBBLED_SYENITE_SLAB.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.COBBLED_SYENITE_STAIRS.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.COBBLED_SYENITE_WALL.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.SYENITE_SLAB.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.SYENITE_STAIRS.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.SYENITE_WALL.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.SYENITE_BRICKS.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.SYENITE_BRICKS_SLAB.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.SYENITE_BRICKS_STAIRS.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.SYENITE_BRICKS_WALL.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.SYENITE_BRICKS_CRACKED.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.SYENITE_BRICKS_CRACKED_SLAB.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.SYENITE_BRICKS_CRACKED_STAIRS.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.SYENITE_BRICKS_CRACKED_WALL.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.SYENITE_BRICKS_CHISELED.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.SYENITE_BRICKS_CHISELED_SLAB.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.SYENITE_BRICKS_CHISELED_STAIRS.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.SYENITE_BRICKS_CHISELED_WALL.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.SYENITE_BRICKS_CHISELED_CRACKED.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.SYENITE_BRICKS_CHISELED_CRACKED_SLAB.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.SYENITE_BRICKS_CHISELED_CRACKED_STAIRS.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.SYENITE_BRICKS_CHISELED_CRACKED_WALL.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.SYENITE_LARGE_TILES.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.SYENITE_LARGE_TILES_SLAB.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.SYENITE_LARGE_TILES_STAIRS.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.SYENITE_LARGE_TILES_WALL.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.SYENITE_LARGE_TILES_CRACKED.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.SYENITE_LARGE_TILES_CRACKED_SLAB.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.SYENITE_LARGE_TILES_CRACKED_STAIRS.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.SYENITE_LARGE_TILES_CRACKED_WALL.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.SYENITE_TILES.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.SYENITE_TILES_SLAB.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.SYENITE_TILES_STAIRS.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.SYENITE_TILES_WALL.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.SYENITE_TILES_CRACKED.get().asItem());
				...
				tabData.accept(SupremeMiningDimensionModItems.WARRIOR_GUARD_SPAWN_EGG.get());
				tabData.accept(SupremeMiningDimensionModItems.WARRIOR_ARCHER_SPAWN_EGG.get());
				tabData.accept(SupremeMiningDimensionModBlocks.LOCKED_BRICKS.get().asItem());
				tabData.accept(SupremeMiningDimensionModItems.IRON_KEY.get());
				tabData.accept(SupremeMiningDimensionModBlocks.LOCKED_BRICKS_EMERALD.get().asItem());
				tabData.accept(SupremeMiningDimensionModItems.IRON_KEY_EMERALD.get());
				tabData.accept(SupremeMiningDimensionModBlocks.LOCKED_BRICKS_LAPIS.get().asItem());
				tabData.accept(SupremeMiningDimensionModItems.IRON_KEY_LAPIS.get());
				tabData.accept(SupremeMiningDimensionModBlocks.LOCKED_BRICKS_TOPAZ.get().asItem());
				tabData.accept(SupremeMiningDimensionModItems.IRON_KEY_TOPAZ.get());
				tabData.accept(SupremeMiningDimensionModBlocks.LOCKED_BRICKS_AMETHYST.get().asItem());
				tabData.accept(SupremeMiningDimensionModItems.IRON_KEY_AMETHYST.get());
				tabData.accept(SupremeMiningDimensionModBlocks.LOCKED_BRICKS_DIAMOND.get().asItem());
				tabData.accept(SupremeMiningDimensionModItems.IRON_KEY_DIAMOND.get());
				tabData.accept(SupremeMiningDimensionModBlocks.LOCKED_BRICKS_RUBY.get().asItem());
				tabData.accept(SupremeMiningDimensionModItems.IRON_KEY_RUBY.get());
				tabData.accept(SupremeMiningDimensionModBlocks.BLACKSHROOM_CAP.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.BLACKSHROOM_CAP_GLOWING.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.WHITESHROOM_CAP.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.WHITESHROOM_CAP_GLOWING.get().asItem());
				tabData.accept(SupremeMiningDimensionModItems.FLAME_RESISTANCE_AUGMENT_ITEM.get());
				tabData.accept(SupremeMiningDimensionModItems.RAW_URANIUM.get());
				tabData.accept(SupremeMiningDimensionModBlocks.URANIUM_ORE.get().asItem());
				tabData.accept(SupremeMiningDimensionModBlocks.AUGMENT_STATION.get().asItem());
				tabData.accept(SupremeMiningDimensionModItems.WATER_BREATHING_AUGMENT.get());
				tabData.accept(SupremeMiningDimensionModItems.CONDUCTIVE_STRIKE.get());
			}).withSearchBar().build());
	...
	public static void buildTabContentsVanilla(BuildCreativeModeTabContentsEvent tabData) {
		...
		if (tabData.getTabKey() == CreativeModeTabs.TOOLS_AND_UTILITIES) {
			tabData.accept(SupremeMiningDimensionModItems.DEFINED_VOID.get());
		}
	}
}
