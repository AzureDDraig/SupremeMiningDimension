...
public class DripstoneCavernsBiome {
	public static Biome createBiome() {
		BiomeSpecialEffects effects = new BiomeSpecialEffects.Builder().fogColor(-5275581).waterColor(4159204).waterFogColor(329011).skyColor(-5275581).foliageColorOverride(10387789).grassColorOverride(9470285).build();
