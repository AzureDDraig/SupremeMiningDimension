...
public class EnderCabin1Feature extends Feature<NoneFeatureConfiguration> {
	public static EnderCabin1Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new EnderCabin1Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("supreme_mining_dimension:ender_cabin_1", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("supreme_mining_dimension:ender_cabin_1", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("supreme_mining_dimension", "endercabin"));
		if (template == null)
			return false;
