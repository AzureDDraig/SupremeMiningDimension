...
public class EnderShipFeature extends Feature<NoneFeatureConfiguration> {
	public static EnderShipFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new EnderShipFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("supreme_mining_dimension:ender_ship", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("supreme_mining_dimension:ender_ship", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("supreme_mining_dimension", "endership"));
		if (template == null)
			return false;
