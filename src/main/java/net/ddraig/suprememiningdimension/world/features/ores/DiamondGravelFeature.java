...
public class DiamondGravelFeature extends OreFeature {
	private final Set<ResourceKey<Level>> generate_dimensions = Set.of(Level.OVERWORLD, ResourceKey.create(Registries.DIMENSION, new ResourceLocation("supreme_mining_dimension:false_overworld_dimension")),
			...
			ResourceKey.create(Registries.DIMENSION, new ResourceLocation("supreme_mining_dimension:deep_caverns")), ResourceKey.create(Registries.DIMENSION, new ResourceLocation("supreme_mining_dimension:strange_forests")), Level.NETHER);
