...
public class LeadOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("supreme_mining_dimension:lead_ore", FEATURE,
				new OreConfiguration(List.of(OreConfiguration.target(new BlockStateMatchTest(Blocks.STONE.defaultBlockState()), SupremeMiningDimensionModBlocks.LEAD_ORE.get().defaultBlockState())), 7));
		PLACED_FEATURE = PlacementUtils.register("supreme_mining_dimension:lead_ore", CONFIGURED_FEATURE,
				List.of(CountPlacement.of(7), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(14), VerticalAnchor.absolute(61)), BiomeFilter.biome()));
		return FEATURE;
	}
