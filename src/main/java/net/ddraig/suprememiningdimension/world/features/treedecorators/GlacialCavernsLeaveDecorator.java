...
public class GlacialCavernsLeaveDecorator extends LeaveVineDecorator {
	public static final GlacialCavernsLeaveDecorator INSTANCE = new GlacialCavernsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		ForgeRegistries.TREE_DECORATOR_TYPES.register("glacial_caverns_tree_leave_decorator", tdt);
	}
