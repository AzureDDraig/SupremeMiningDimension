...
public class OvergrownCavernsLeaveDecorator extends LeaveVineDecorator {
	public static final OvergrownCavernsLeaveDecorator INSTANCE = new OvergrownCavernsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		ForgeRegistries.TREE_DECORATOR_TYPES.register("overgrown_caverns_tree_leave_decorator", tdt);
	}
